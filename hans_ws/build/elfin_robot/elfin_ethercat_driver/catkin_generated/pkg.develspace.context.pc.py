...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/workspace/src/elfin_robot/elfin_ethercat_driver/include".split(';') if "/workspace/src/elfin_robot/elfin_ethercat_driver/include" != "" else []
